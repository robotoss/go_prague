...
class CityBarProductCard extends StatefulWidget {
  final CategoryItem categoryItem;
  final String barName;

  CityBarProductCard({this.categoryItem, this.barName});

  @override
  _CityBarProductCardState createState() =>
      _CityBarProductCardState();
}
