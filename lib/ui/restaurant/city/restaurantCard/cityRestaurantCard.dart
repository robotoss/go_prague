  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector(
        onTap: (){
          Navigator.push(context, MaterialPageRoute(builder: (context) => CityRestaurantListScreen(hotelRestaurantItems:  widget.categoryItem.cityRestaurantItems, restaurantName: widget.categoryItem.restaurantName,)));
        },
        child: Card(
          child: Container(
            height: 250,
